...
/* Add new columns */
ALTER TABLE top_10_Duplicated_Artists
ADD COLUMN artist_id_2 INT,
ADD COLUMN artist_id_3 INT,
...
/* Add new columns */
ALTER TABLE top_10_Duplicated_Albums
ADD COLUMN album_id_2 INT,
ADD COLUMN album_id_3 INT,
ADD COLUMN total_users INT;
...
/* Add new columns */
ALTER TABLE top_10_Duplicated_Songs
ADD COLUMN song_id_2 INT,
ADD COLUMN song_id_3 INT,
ADD COLUMN total_users INT;
